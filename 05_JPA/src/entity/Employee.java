...
@NamedQuery(name="Employee.id" ,query="Select e from Employee e where e.id=:id")
@NamedQuery(name="Employee.name" ,query="Select e from Employee e")
//@NamedQuery(name="Employee.name" ,query="Select e from Employee e where e.salary>?1")
//@NamedQuery(name="Employee.name" ,query="Select e from Employee e where e.id=:id")
/*@NamedQueries({@NamedQuery(name="Employee.name" ,query="Select e from Employee e"),
	@NamedQuery(name="Employee.name" ,query="Select e from Employee e where e.salary>?1")})*/
